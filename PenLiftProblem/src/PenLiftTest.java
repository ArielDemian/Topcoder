...
public class PenLiftTest {
	...
	public void test0() {
		...
		int n = 1;
		int expected = 1;
		assertEquals(expected, p.numTimes(segments, n));
	}

	@Test
	public void test1() {
		String[] segments = { "-10 0 0 0", "0 0 10 0", "0 -10 0 0", "0 0 0 10" };
		int n = 1;
		int expected = 1;
		assertEquals(expected, p.numTimes(segments, n));
	}
	...
	@Test
	public void test3() {
		String[] segments = { "0 0 1 0", "2 0 4 0", "5 0 8 0", "9 0 13 0", "0 1 1 1", "2 1 4 1", "5 1 8 1", "9 1 13 1", "0 0 0 1", "1 0 1 1", "2 0 2 1", "3 0 3 1", "4 0 4 1", "5 0 5 1", "6 0 6 1", "7 0 7 1", "8 0 8 1", "9 0 9 1", "10 0 10 1", "11 0 11 1", "12 0 12 1", "13 0 13 1" };
		int n = 1;
		int expected = 6;
		assertEquals(expected, p.numTimes(segments, n));
	}
	...
	@Test
	public void test4() {
		String[] segments = { "-2 6 -2 1", "2 6 2 1", "6 -2 1 -2", "6 2 1 2", "-2 5 -2 -1", "2 5 2 -1", "5 -2 -1 -2", "5 2 -1 2", "-2 1 -2 -5", "2 1 2 -5", "1 -2 -5 -2", "1 2 -5 2", "-2 -1 -2 -6", "2 -1 2 -6", "-1 -2 -6 -2", "-1 2 -6 2" };
		int n = 5;
		int expected = 3;
		assertEquals(expected, p.numTimes(segments, n));
	}
